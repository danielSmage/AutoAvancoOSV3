...
class BotTelnet:
    ...
    def conectar_e_navegar(self):
        ...
        self._log("?? Identificacao (Usu�rio e Senha do ERP)...")
        ...
        if "LIDO" in tela.upper():
            self._log("   [!] Tela de Hist�rico detectada, pressionando ESC.")
        ...
        self._log("??  Menu Principal -> Administra��o Materiais...")
        # Usa M para descer para a segunda op��o com seguran�a e acessa Filial 70
        ...
        self._log("? Tela pronta para digita��o!")
